...
class Secretaire extends DatabaseObject {

  static protected $table_name = "secretaire";
  static protected $db_columns = ['id_secretaire', 'prenom_secretaire',
   'nom_secretaire', 'username', 'date_de_naissance', 'sexe',
    'telephone', 'image', 'email',  'hashed_password'];
